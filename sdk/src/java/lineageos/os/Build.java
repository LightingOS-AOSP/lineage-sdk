...
public class Build {
    ...
    public static final String LIGHTNING_VERSION = getString("ro.lightning.version.base");

    /** A build ID string meant for displaying to the user */
    public static final String LIGHTNING_DISPLAY_VERSION = getString("ro.lightning.version_display");
